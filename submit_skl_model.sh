...
python scripts/skl_train_model.py  --data_file input/combined_DepMap_21Q3.csv --drug_name "BRD-A39189014-003-22-7::2.5::HTS" --config_file configs/xgb_config.json --out_dir output/models --n_cores 18
