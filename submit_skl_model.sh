...
python scripts/skl_train_smodel.py  --data_file input/combined_DepMap_21Q3.csv --drug_name "BRD-A39189014-003-22-7::2.5::HTS" --config_file configs/xgb_config_simple.json --out_dir output/ --n_cores 22
